/**
 * ApprovalRequests Store
 * Zustand 기반 결재 요청 관리 UI 상태 관리
 */

import { create } from 'zustand';
import type { Updater } from '@tanstack/react-table';

interface ApprovalRequestsStoreState {
  // Form/Modal 상태
  formOpen: boolean;
...
export const useApprovalRequestsStore = create<ApprovalRequestsStoreState>((set) => ({
  // 초기 상태
  formOpen: false,
  editingId: null,
  globalFilter: '',
