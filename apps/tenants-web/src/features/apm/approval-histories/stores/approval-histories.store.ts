/**
 * ApprovalHistories Store
 * Zustand 기반 결재 이력 관리 UI 상태 관리
 */

import { create } from 'zustand';
import type { Updater } from '@tanstack/react-table';

interface ApprovalHistoriesStoreState {
  // Form/Modal 상태
  formOpen: boolean;
...
export const useApprovalHistoriesStore = create<ApprovalHistoriesStoreState>((set) => ({
  // 초기 상태
  formOpen: false,
  editingId: null,
  globalFilter: '',
