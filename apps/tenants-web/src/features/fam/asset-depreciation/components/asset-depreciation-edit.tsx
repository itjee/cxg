...
interface AssetDepreciationEditProps {
  data: any[];
  onSubmit: (formData: Record<string, any>) => void;
}

export function AssetDepreciationEdit({ data, onSubmit }: AssetDepreciationEditProps) {
  const { formOpen, editingId, closeForm } = useAssetDepreciationStore();
