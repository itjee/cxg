/**
 * AssetDepreciation Store
 * Zustand 기반 감가상각 관리 UI 상태 관리
 */

import { create } from 'zustand';
import type { Updater } from '@tanstack/react-table';

interface AssetDepreciationStoreState {
  // Form/Modal 상태
  formOpen: boolean;
...
export const useAssetDepreciationsStore = create<AssetDepreciationStoreState>((set) => ({
  // 초기 상태
  formOpen: false,
  editingId: null,
  globalFilter: '',
