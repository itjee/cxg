/**
 * KpiDefinitions Store
 * Zustand 기반 KPI 정의 관리 UI 상태 관리
 */

import { create } from 'zustand';
import type { Updater } from '@tanstack/react-table';

interface KpiDefinitionsStoreState {
  // Form/Modal 상태
  formOpen: boolean;
...
export const useKpiDefinitionsStore = create<KpiDefinitionsStoreState>((set) => ({
  // 초기 상태
  formOpen: false,
  editingId: null,
  globalFilter: '',
