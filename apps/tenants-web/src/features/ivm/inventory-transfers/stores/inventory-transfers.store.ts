 ...
 * Zustand 기반 InventoryTransfer 관리 UI 상태 관리
 */

import { create } from 'zustand';
import type { Updater } from '@tanstack/react-table';

interface InventoryTransferStoreState {
  formOpen: boolean;
...
export const useInventoryTransferStore = create<InventoryTransferStoreState>((set) => ({
  formOpen: false,
  editingId: null,
  globalFilter: '',
  sorting: [],
