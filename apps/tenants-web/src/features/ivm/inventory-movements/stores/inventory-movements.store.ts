 ...
 * Zustand 기반 InventoryMovement 관리 UI 상태 관리
 */

import { create } from 'zustand';
import type { Updater } from '@tanstack/react-table';

interface InventoryMovementStoreState {
  formOpen: boolean;
...
export const useInventoryMovementStore = create<InventoryMovementStoreState>((set) => ({
  formOpen: false,
  editingId: null,
  globalFilter: '',
  sorting: [],
