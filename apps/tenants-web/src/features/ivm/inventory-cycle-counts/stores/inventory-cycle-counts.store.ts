/**
 * InventoryCycleCount Store
 * Zustand 기반 InventoryCycleCount 관리 UI 상태 관리
 */

import { create } from 'zustand';
import type { Updater } from '@tanstack/react-table';

interface InventoryCycleCountStoreState {
  formOpen: boolean;
...
export const useInventoryCycleCountStore = create<InventoryCycleCountStoreState>((set) => ({
  formOpen: false,
  editingId: null,
  globalFilter: '',
  sorting: [],
