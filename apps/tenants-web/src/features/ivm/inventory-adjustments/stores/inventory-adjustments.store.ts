/**
 * InventoryAdjustment Store
 * Zustand 기반 InventoryAdjustment 관리 UI 상태 관리
 */

import { create } from 'zustand';
import type { Updater } from '@tanstack/react-table';

interface InventoryAdjustmentStoreState {
  formOpen: boolean;
...
export const useInventoryAdjustmentStore = create<InventoryAdjustmentStoreState>((set) => ({
  formOpen: false,
  editingId: null,
  globalFilter: '',
  sorting: [],
