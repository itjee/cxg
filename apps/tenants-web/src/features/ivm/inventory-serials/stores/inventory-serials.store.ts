/**
 * InventorySerial Store
 * Zustand 기반 InventorySerial 관리 UI 상태 관리
 */

import { create } from 'zustand';
import type { Updater } from '@tanstack/react-table';

interface InventorySerialStoreState {
  formOpen: boolean;
...
export const useInventorySerialStore = create<InventorySerialStoreState>((set) => ({
  formOpen: false,
  editingId: null,
  globalFilter: '',
  sorting: [],
