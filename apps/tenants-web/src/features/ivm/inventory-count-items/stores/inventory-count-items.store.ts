/**
 * InventoryCountItem Store
 * Zustand 기반 InventoryCountItem 관리 UI 상태 관리
 */

import { create } from 'zustand';
import type { Updater } from '@tanstack/react-table';

interface InventoryCountItemStoreState {
  formOpen: boolean;
...
export const useInventoryCountItemStore = create<InventoryCountItemStoreState>((set) => ({
  formOpen: false,
  editingId: null,
  globalFilter: '',
  sorting: [],
