/**
 * InventoryReservation Store
 * Zustand 기반 InventoryReservation 관리 UI 상태 관리
 */

import { create } from 'zustand';
import type { Updater } from '@tanstack/react-table';

interface InventoryReservationStoreState {
  formOpen: boolean;
...
export const useInventoryReservationStore = create<InventoryReservationStoreState>((set) => ({
  formOpen: false,
  editingId: null,
  globalFilter: '',
  sorting: [],
