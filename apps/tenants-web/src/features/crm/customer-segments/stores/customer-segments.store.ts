/**
 * Customer Segments Store
 * Zustand 기반 customer segments 관리 UI 상태 관리
 */

import { create } from 'zustand';
import type { Updater } from '@tanstack/react-table';

interface CustomerSegmentsStoreState {
  formOpen: boolean;
...
export const useCustomerSegmentsStore = create<CustomerSegmentsStoreState>((set) => ({
  formOpen: false,
  editingId: null,
  globalFilter: '',
  selectedType: '',
