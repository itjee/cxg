/**
 * Customer Surveys Store
 * Zustand 기반 customer surveys 관리 UI 상태 관리
 */

import { create } from 'zustand';
import type { Updater } from '@tanstack/react-table';

interface CustomerSurveysStoreState {
  formOpen: boolean;
...
export const useCustomerSurveysStore = create<CustomerSurveysStoreState>((set) => ({
  formOpen: false,
  editingId: null,
  globalFilter: '',
  selectedType: '',
