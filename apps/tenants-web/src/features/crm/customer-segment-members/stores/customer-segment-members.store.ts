/**
 * Customer Segment Members Store
 * Zustand 기반 customer segment members 관리 UI 상태 관리
 */

import { create } from 'zustand';
import type { Updater } from '@tanstack/react-table';

interface CustomerSegmentMembersStoreState {
  formOpen: boolean;
...
export const useCustomerSegmentMembersStore = create<CustomerSegmentMembersStoreState>((set) => ({
  formOpen: false,
  editingId: null,
  globalFilter: '',
  selectedType: '',
