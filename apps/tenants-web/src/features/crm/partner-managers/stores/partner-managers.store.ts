/**
 * Partner Managers Store
 * Zustand 기반 partner managers 관리 UI 상태 관리
 */

import { create } from 'zustand';
import type { Updater } from '@tanstack/react-table';

interface PartnerManagersStoreState {
  formOpen: boolean;
...
export const usePartnerManagersStore = create<PartnerManagersStoreState>((set) => ({
  formOpen: false,
  editingId: null,
  globalFilter: '',
  selectedType: '',
