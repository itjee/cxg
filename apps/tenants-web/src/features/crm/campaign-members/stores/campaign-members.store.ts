/**
 * Campaign Members Store
 * Zustand 기반 campaign members 관리 UI 상태 관리
 */

import { create } from 'zustand';
import type { Updater } from '@tanstack/react-table';

interface CampaignMembersStoreState {
  formOpen: boolean;
...
export const useCampaignMembersStore = create<CampaignMembersStoreState>((set) => ({
  formOpen: false,
  editingId: null,
  globalFilter: '',
  selectedType: '',
