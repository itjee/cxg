/**
 * Partner Addresses Store
 * Zustand 기반 partner addresses 관리 UI 상태 관리
 */

import { create } from 'zustand';
import type { Updater } from '@tanstack/react-table';

interface PartnerAddressesStoreState {
  formOpen: boolean;
...
export const usePartnerAddressesStore = create<PartnerAddressesStoreState>((set) => ({
  formOpen: false,
  editingId: null,
  globalFilter: '',
  selectedType: '',
