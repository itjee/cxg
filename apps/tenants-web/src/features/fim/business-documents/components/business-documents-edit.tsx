...
interface BusinessDocumentsEditProps {
  data: any[];
  onSubmit: (formData: Record<string, any>) => void;
}

export function BusinessDocumentsEdit({ data, onSubmit }: BusinessDocumentsEditProps) {
  const { formOpen, editingId, closeForm } = useBusinessDocumentsStore();
