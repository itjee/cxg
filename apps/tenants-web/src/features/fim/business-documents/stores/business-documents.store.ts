/**
 * BusinessDocuments Store
 * Zustand 기반 증빙서류 관리 UI 상태 관리
 */

import { create } from 'zustand';
import type { Updater } from '@tanstack/react-table';

interface BusinessDocumentsStoreState {
  // Form/Modal 상태
  formOpen: boolean;
...
export const useBusinessDocumentsStore = create<BusinessDocumentsStoreState>((set) => ({
  // 초기 상태
  formOpen: false,
  editingId: null,
  globalFilter: '',
