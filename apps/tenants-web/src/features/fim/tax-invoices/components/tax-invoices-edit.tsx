...
interface TaxInvoicesEditProps {
  data: any[];
  onSubmit: (formData: Record<string, any>) => void;
}

export function TaxInvoicesEdit({ data, onSubmit }: TaxInvoicesEditProps) {
  const { formOpen, editingId, closeForm } = useTaxInvoicesStore();
