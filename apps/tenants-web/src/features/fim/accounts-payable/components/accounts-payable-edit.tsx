...
interface AccountsPayableEditProps {
  data: any[];
  onSubmit: (formData: Record<string, any>) => void;
}

export function AccountsPayableEdit({ data, onSubmit }: AccountsPayableEditProps) {
  const { formOpen, editingId, closeForm } = useAccountsPayableStore();
