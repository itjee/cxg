/**
 * AccountsPayable Store
 * Zustand 기반 매입채무 관리 UI 상태 관리
 */

import { create } from 'zustand';
import type { Updater } from '@tanstack/react-table';

interface AccountsPayableStoreState {
  // Form/Modal 상태
  formOpen: boolean;
...
export const useAccountsPayableStore = create<AccountsPayableStoreState>((set) => ({
  // 초기 상태
  formOpen: false,
  editingId: null,
  globalFilter: '',
