...
interface JournalEntryLinesEditProps {
  data: any[];
  onSubmit: (formData: Record<string, any>) => void;
}

export function JournalEntryLinesEdit({ data, onSubmit }: JournalEntryLinesEditProps) {
  const { formOpen, editingId, closeForm } = useJournalEntryLinesStore();
