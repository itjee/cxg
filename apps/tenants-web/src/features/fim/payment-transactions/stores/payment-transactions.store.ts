/**
 * PaymentTransactions Store
 * Zustand 기반 지급 거래 관리 UI 상태 관리
 */

import { create } from 'zustand';
import type { Updater } from '@tanstack/react-table';

interface PaymentTransactionsStoreState {
  // Form/Modal 상태
  formOpen: boolean;
...
export const usePaymentTransactionsStore = create<PaymentTransactionsStoreState>((set) => ({
  // 초기 상태
  formOpen: false,
  editingId: null,
  globalFilter: '',
