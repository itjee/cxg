...
interface PaymentTransactionsEditProps {
  data: any[];
  onSubmit: (formData: Record<string, any>) => void;
}

export function PaymentTransactionsEdit({ data, onSubmit }: PaymentTransactionsEditProps) {
  const { formOpen, editingId, closeForm } = usePaymentTransactionsStore();
