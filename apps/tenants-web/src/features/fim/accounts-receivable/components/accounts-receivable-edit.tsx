...
interface AccountsReceivableEditProps {
  data: any[];
  onSubmit: (formData: Record<string, any>) => void;
}

export function AccountsReceivableEdit({ data, onSubmit }: AccountsReceivableEditProps) {
  const { formOpen, editingId, closeForm } = useAccountsReceivableStore();
