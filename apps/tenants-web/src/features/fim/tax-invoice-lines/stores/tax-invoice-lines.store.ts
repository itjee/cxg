/**
 * TaxInvoiceLines Store
 * Zustand 기반 세금계산서 라인 관리 UI 상태 관리
 */

import { create } from 'zustand';
import type { Updater } from '@tanstack/react-table';

interface TaxInvoiceLinesStoreState {
  // Form/Modal 상태
  formOpen: boolean;
...
export const useTaxInvoiceLinesStore = create<TaxInvoiceLinesStoreState>((set) => ({
  // 초기 상태
  formOpen: false,
  editingId: null,
  globalFilter: '',
