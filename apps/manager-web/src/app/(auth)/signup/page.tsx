...
import { BarChart3, Users, Workflow, Star, User } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-neutral-950 via-neutral-900 to-black relative overflow-hidden">
      ...
      <div className="flex pt-[60px] min-h-screen">
        ...
        <div
          className="flex-1 lg:w-1/2 flex items-start justify-center py-12 relative z-10 animate-slide-in-left"
        ...
        <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
          <div
            className="relative z-10 flex flex-col justify-between py-12 text-white w-full animate-slide-in-right"
          ...
          >
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4 group">
                ...
                <div>
                  ...
                  <p className="text-neutral-400 text-base leading-relaxed">
                    기본 기능은 무료로 제공되며, 필요에 따라 언제든 업그레이드
                    가능합니다
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 group">
                ...
                <div>
                  <h3 className="font-semibold text-xl mb-1">팀과 함께 협업</h3>
                  <p className="text-neutral-400 text-base leading-relaxed">
                    팀원 초대부터 권한 관리까지, 협업에 필요한 모든 기능을
                    제공합니다
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 group">
                ...
                <div>
                  <h3 className="font-semibold text-xl mb-1">5분 만에 시작</h3>
                  <p className="text-neutral-400 text-base leading-relaxed">
                    복잡한 설정 없이 바로 시작하세요. 직관적인 인터페이스로 쉽게
                    사용할 수 있습니다
                  </p>
                </div>
              </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-2 text-base border-t border-neutral-800 pt-6">
                <div className="flex -space-x-2">
                  {[1, 2, 3, 4].map((i) => (
                    <div
                      key={i}
                      className="h-8 w-8 rounded-full bg-violet-600/20 border-2 border-violet-600 flex items-center justify-center"
                    >
              ...
              <div className="flex items-center gap-4">
                <div className="flex items-center gap-1">
                  {[1, 2, 3, 4, 5].map((i) => (
                    <Star
                      key={i}
                      className="h-5 w-5 fill-violet-400 text-violet-400"
                    />
                  ))}
                </div>
                <p className="text-base text-neutral-400">
                  <span className="font-semibold text-white">4.9/5</span> 평균
                  만족도
                </p>
              </div>
