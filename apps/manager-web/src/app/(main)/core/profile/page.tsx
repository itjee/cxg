          ...
          <div className="flex items-start gap-6">
            ...
            <div className="flex-1 space-y-3">
              <div>
                ...
                <p className="text-base text-muted-foreground">admin@cxg.com</p>
              </div>
              <div className="flex gap-2">
                <div className="inline-flex items-center rounded-md bg-primary/10 px-2.5 py-0.5 text-sm font-semibold text-primary">
                  시스템 관리자
                </div>
                <div className="inline-flex items-center rounded-md bg-secondary px-2.5 py-0.5 text-sm font-semibold">
                  최고 권한
                </div>
              </div>
            </div>
