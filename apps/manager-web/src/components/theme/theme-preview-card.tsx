  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-6">
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-lg">카드 예시</CardTitle>
        ...
        <div className="space-y-2 p-4 rounded-lg bg-muted">
          <p className="text-base font-medium">텍스트 색상</p>
          <p className="text-base text-foreground">기본 텍스트 (Foreground)</p>
          <p className="text-base text-muted-foreground">보조 텍스트 (Muted Foreground)</p>
          <p className="text-base text-primary">강조 텍스트 (Primary)</p>
        </div>
      </CardContent>
    </Card>
  );
