    ...
    <Card className="transition-all hover:shadow-lg hover:shadow-primary/10">
      <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-4">
        ...
        <div className="flex gap-2">
          <button className="px-3 py-1.5 text-xs text-muted-foreground hover:bg-muted rounded-lg transition-colors">
            지난 7일
          </button>
          <button className="px-3 py-1.5 text-xs bg-primary/10 text-primary rounded-lg">
            지난 30일
          </button>
          <button className="px-3 py-1.5 text-xs text-muted-foreground hover:bg-muted rounded-lg transition-colors">
            지난 90일
