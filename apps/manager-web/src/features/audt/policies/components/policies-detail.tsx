    ...
    <Dialog open={!!detailId} onOpenChange={closeDetail}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-6">
          <div>
            <h3 className="text-xl font-semibold mb-2">{policy.policy_name}</h3>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <p className="text-base text-muted-foreground">버전</p>
              <p className="mt-1 text-xl font-semibold">{policy.version}</p>
            </div>
            <div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <p className="text-base text-muted-foreground">시행일</p>
              <p className="mt-1">{formatDate(policy.effective_date, "yyyy-MM-dd")}</p>
            </div>
            <div>
              <p className="text-base text-muted-foreground">만료일</p>
              <p className="mt-1">
          ...
          <div>
            <p className="text-base text-muted-foreground mb-2">정책 규칙</p>
          ...
          {policy.previous_version_id && (
            <div>
              <p className="text-base text-muted-foreground">이전 버전 ID</p>
          ...
          <div className="grid grid-cols-2 gap-4 pt-4 border-t">
            <div>
              ...
              <p className="mt-1 text-sm">{formatDate(policy.created_at, "yyyy-MM-dd HH:mm:ss")}</p>
            </div>
            {policy.updated_at && (
              <div>
                <p className="text-base text-muted-foreground">수정일시</p>
                <p className="mt-1 text-sm">{formatDate(policy.updated_at, "yyyy-MM-dd HH:mm:ss")}</p>
              </div>
            )}
          </div>
        </div>
