...
import { Sessions as SessionsIcon, SessionCheck, SessionX, Shield } from "lucide-react";
    ...
    return [
      {
        ...
        description: "총 사용자 수",
        icon: <SessionsIcon className="h-5 w-5" />,
      ...
      },
      {
        ...
        icon: <SessionCheck className="h-5 w-5" />,
      ...
      },
      {
        ...
        icon: <SessionX className="h-5 w-5" />,
