...
CREATE INDEX IF NOT EXISTS ix_goods_receipts__tenant_id     ON lwm.goods_receipts (tenant_id) WHERE deleted = false;
CREATE INDEX IF NOT EXISTS ix_goods_receipts__company_id    ON lwm.goods_receipts (company_id) WHERE deleted = false;
...
CREATE INDEX IF NOT EXISTS ix_goods_receipt_lines__item_id  ON lwm.goods_receipt_lines (item_id);

CREATE INDEX IF NOT EXISTS ix_goods_issues__tenant_id       ON lwm.goods_issues (tenant_id) WHERE deleted = false;
CREATE INDEX IF NOT EXISTS ix_goods_issues__company_id      ON lwm.goods_issues (company_id) WHERE deleted = false;
...
CREATE INDEX IF NOT EXISTS ix_goods_issue_lines__item_id    ON lwm.goods_issue_lines (item_id);

-- =====================================================================================
-- 유니크 제약 조건
-- =====================================================================================

CREATE UNIQUE INDEX IF NOT EXISTS ux_goods_receipts__company_code   ON lwm.goods_receipts (company_id, gr_code) WHERE deleted = false;
CREATE UNIQUE INDEX IF NOT EXISTS ux_goods_receipt_lines__gr_line   ON lwm.goods_receipt_lines (gr_id, line_no);
CREATE UNIQUE INDEX IF NOT EXISTS ux_goods_issues__company_code     ON lwm.goods_issues (company_id, gi_code) WHERE deleted = false;
