...
CREATE INDEX IF NOT EXISTS ix_inventory_balances__tenant_id     ON ivm.inventory_balances (tenant_id);
...
CREATE INDEX IF NOT EXISTS ix_inventory_movements__tenant_id    ON ivm.inventory_movements (tenant_id);
