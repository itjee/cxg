...
CREATE UNIQUE INDEX IF NOT EXISTS ux_purchase_requisitions__pr_code ON psm.purchase_requisitions (pr_code) WHERE deleted = false;
CREATE UNIQUE INDEX IF NOT EXISTS ux_purchase_requisition_lines__pr_line ON psm.purchase_requisition_lines (pr_id, line_no);
CREATE UNIQUE INDEX IF NOT EXISTS ux_purchase_orders__po_code ON psm.purchase_orders (po_code) WHERE deleted = false;
